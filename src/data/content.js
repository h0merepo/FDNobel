...
export const THEMES = [
  ...
  { id: 'creativity', label: 'Creativity', weight: 3, blurb: 'Seeing a shape nobody has drawn yet — in a molecule, a sentence, a proof.', laureates: ['einstein', 'morrison', 'curie', 'beckett'], milestones: ['modern-physics'], related: ['imagination', 'play', 'dreams'] },
  { id: 'revolt', label: 'Revolt', weight: 2, blurb: 'Refusing the settled account. Every paradigm was once an act of disobedience.', laureates: ['mandela', 'einstein', 'mccli', 'sakharov', 'yousafzai'], milestones: ['modern-physics', 'human-rights'], related: ['courage', 'doubt', 'outsiders'] },
  ...
  { id: 'courage', label: 'Courage', weight: 2, blurb: 'Standing in the open when it costs something. Speech, exile, prison, silence broken.', laureates: ['mandela', 'addams', 'sakharov', 'suu-kyi', 'yousafzai', 'gbowee'], milestones: ['human-rights', 'nazism'], related: ['revolt', 'conscience', 'women-rights'] },
  { id: 'play', label: 'Play', weight: 2, blurb: 'Serious work that looks like fiddling. Toys, puzzles and tinkering that turn into physics.', laureates: ['feynman', 'geim', 'hassabis'], milestones: ['modern-physics'], related: ['creativity', 'imagination', 'youth'] },
  { id: 'solitude', label: 'Solitude', weight: 2, blurb: 'Long stretches alone with a problem — the quiet that most breakthroughs are made of.', laureates: ['mccli', 'dirac', 'morrison', 'heisenberg', 'beckett'], milestones: [], related: ['persistence', 'doubt'] },
  { id: 'dreams', label: 'Dreams', weight: 3, blurb: 'Answers arriving sideways, in sleep or reverie, when the reasoning mind lets go.', laureates: ['loewi', 'marquez', 'gbowee', 'doudna', 'charpentier'], milestones: [], related: ['imagination', 'creativity'] },
  ...
  { id: 'collaboration', label: 'Collaboration', weight: 3, blurb: 'Prizes name three people. Discoveries rarely have so few authors.', laureates: ['crick', 'curie', 'banting', 'heisenberg', 'charpentier', 'hassabis'], milestones: ['dna', 'insulin'], related: ['mentoring', 'invisible-hands'] },
  { id: 'persistence', label: 'Persistence', weight: 2, blurb: 'Tonnes of ore reduced to a decigram of radium. The unglamorous middle of the story.', laureates: ['curie', 'mccli', 'katalin', 'mandela', 'gbowee', 'yamanaka', 'goldin'], milestones: ['radioactivity', 'mrna'], related: ['solitude', 'testing', 'patience'] },
  { id: 'observation', label: 'Observation', weight: 3, blurb: 'Looking harder at what everyone else has already looked at.', laureates: ['koch', 'fleming', 'mccli', 'lorenz', 'rontgen'], milestones: ['microorganisms'], related: ['invisible-worlds', 'instruments', 'senses-behaviour'] },
  { id: 'imagination', label: 'Imagination', weight: 3, blurb: 'Riding a beam of light. Picturing a world you cannot yet measure.', laureates: ['einstein', 'morrison', 'marquez', 'townes', 'higgs'], milestones: ['modern-physics'], related: ['creativity', 'dreams', 'storytelling'] },
  ...
  { id: 'testing', label: 'Testing', weight: 1, blurb: 'The discipline of trying to prove yourself wrong, thousands of times.', laureates: ['banting', 'katalin', 'fleming', 'yamanaka'], milestones: ['insulin'], related: ['persistence', 'doubt'] },
  ...
  { id: 'the-atomic-age', label: 'The Atomic Age', weight: 2, blurb: 'The same physics that lit cities also ended two of them.', laureates: ['curie', 'fermi', 'einstein', 'rotblat'], milestones: ['atomic-age', 'nuclear-arms'], related: ['arms-defense', 'conscience', 'invisible-worlds'] },
  ...
  { id: 'genes', label: 'Genes', weight: 1, blurb: 'Instructions written in four letters, jumping, folding, mutating.', laureates: ['crick', 'mccli', 'doudna', 'mullis', 'yamanaka', 'charpentier'], milestones: ['dna', 'crispr'], related: ['invisible-worlds', 'code'] },
  { id: 'women-rights', label: "Women's Rights", weight: 1, blurb: 'Suffrage, settlement houses, schooling — and the laureates who were kept from laboratories.', laureates: ['addams', 'balch', 'yousafzai', 'curie', 'lagerlof', 'gbowee', 'goldin', 'suttner'], milestones: ['human-rights'], related: ['courage', 'outsiders'] },
  { id: 'arms-defense', label: 'Arms and Defense', weight: 2, blurb: 'Disarmament treaties written by people who helped build the weapons.', laureates: ['sakharov', 'pauling', 'rotblat', 'suttner'], milestones: ['nuclear-arms', 'world-war-i'], related: ['the-atomic-age', 'conscience', 'peacebuilding'] },
  { id: 'economic-history', label: 'Economic History and Business Cycles', weight: 2, blurb: 'Booms, crashes and the models that failed to see them coming.', laureates: ['friedman', 'ostrom', 'sen', 'goldin'], milestones: ['depression'], related: ['commons', 'inequality'] },
  { id: 'conscience', label: 'Conscience', weight: 2, blurb: 'Scientists who campaigned against their own creations.', laureates: ['mandela', 'sakharov', 'pauling', 'einstein', 'rotblat', 'charpentier'], milestones: ['nuclear-arms'], related: ['courage', 'arms-defense', 'the-atomic-age'] },
  ...
  { id: 'outsiders', label: 'Outsiders', weight: 2, blurb: 'Amateurs, clerks, immigrants and unpaid assistants who changed the field they were shut out of.', laureates: ['mandela', 'einstein', 'mccli', 'ernaux', 'katalin'], milestones: [], related: ['revolt', 'exile', 'persistence'] },
  { id: 'instruments', label: 'Instruments', weight: 2, blurb: 'You cannot see a thing until someone builds the thing that sees it.', laureates: ['rontgen', 'ruska', 'betzig', 'townes', 'hassabis'], milestones: ['microorganisms', 'modern-physics'], related: ['invisible-worlds', 'observation', 'scale'] },
  { id: 'scale', label: 'Scale', weight: 1, blurb: 'From quarks to galaxies — the vertigo of very small and very large numbers.', laureates: ['einstein', 'penrose', 'higgs'], milestones: ['modern-physics', 'cosmology'], related: ['invisible-worlds', 'instruments'] },
  { id: 'storytelling', label: 'Storytelling', weight: 3, blurb: 'Literature laureates who rewrote whose life counts as a story.', laureates: ['morrison', 'marquez', 'brodsky', 'ernaux', 'lagerlof', 'alexievich'], milestones: [], related: ['imagination', 'memory', 'language'] },
  { id: 'memory', label: 'Memory', weight: 2, blurb: 'What a nerve cell keeps; what a country agrees to forget.', laureates: ['kandel', 'morrison', 'brodsky', 'alexievich'], milestones: ['holocaust'], related: ['senses-behaviour', 'storytelling', 'truth'] },
  { id: 'language', label: 'Language', weight: 1, blurb: 'Prizes given for sentences — and for the languages a prize never reads.', laureates: ['morrison', 'marquez', 'ernaux', 'beckett'], milestones: [], related: ['storytelling', 'translation'] },
  ...
  { id: 'patience', label: 'Patience', weight: 1, blurb: 'Forty years between a finding and its recognition. McClintock waited.', laureates: ['mccli', 'katalin', 'mandela', 'higgs'], milestones: ['crispr', 'mrna'], related: ['persistence', 'chance'] },
  { id: 'hunger', label: 'Hunger', weight: 2, blurb: 'Nitrogen out of air; dwarf wheat; food aid convoys. Also the famines these did not stop.', laureates: ['haber', 'borlaug', 'wfp', 'sen'], milestones: ['fertilizers', 'green-revolution'], related: ['healthcare', 'commons'] },
  ...
  { id: 'peacebuilding', label: 'Peacebuilding', weight: 2, blurb: 'Settlement houses, mediation tables, refugee agencies — slow work with no clean ending.', laureates: ['mandela', 'addams', 'balch', 'suu-kyi', 'gbowee', 'suttner'], milestones: ['human-rights', 'world-war-i'], related: ['courage', 'arms-defense', 'women-rights'] },
  ...
  { id: 'code', label: 'Code', weight: 1, blurb: 'Nature as something written — and, eventually, something edited.', laureates: ['crick', 'doudna', 'mullis', 'charpentier', 'hassabis'], milestones: ['dna', 'crispr'], related: ['genes', 'invisible-worlds'] },
  { id: 'truth', label: 'Truth', weight: 2, blurb: 'Journalists and dissidents awarded for refusing an official version.', laureates: ['sakharov', 'ressa', 'alexievich'], milestones: ['human-rights'], related: ['courage', 'memory', 'conscience'] },
  ...
  { id: 'inequality', label: 'Inequality', weight: 1, blurb: 'Who receives prizes, who receives treatment, and who is counted in the data.', laureates: ['ostrom', 'addams', 'sen', 'goldin'], milestones: ['depression'], related: ['economic-history', 'women-rights'] },
  ...
  // Six keywords from the shortlist that the cloud had no theme for. They are
  // about the shape of a working life rather than its subject, which is why
  // none of the existing forty-five quite covered them.
  { id: 'eureka', label: 'Eureka!', weight: 3, blurb: 'The moment itself: a park bench, a night drive, a treeless island at three in the morning. Almost always preceded by years of nothing.', laureates: ['townes', 'heisenberg', 'mullis', 'lagerlof'], milestones: ['modern-physics'], related: ['serendipity', 'inspiration', 'creativity'] },
  { id: 'serendipity', label: 'Serendipity', weight: 2, blurb: 'Not luck — luck noticed. The difference between a spoiled experiment and a discovery is who is standing over it.', laureates: ['rontgen', 'fleming', 'shirakawa'], milestones: ['antibiotics'], related: ['chance', 'accident', 'observation'] },
  { id: 'inspiration', label: 'Inspiration', weight: 2, blurb: 'Where the work comes from when it does not come from the work: a landscape, a language, another writer\'s sentence.', laureates: ['lagerlof', 'beckett'], milestones: [], related: ['eureka', 'creativity', 'imagination'] },
  { id: 'influence', label: 'Influence', weight: 2, blurb: 'What a body of work does after it leaves the person who made it — in other laboratories, other novels, other lives.', laureates: ['curie', 'beckett', 'higgs'], milestones: [], related: ['mentoring', 'storytelling'] },
  { id: 'commitment', label: 'Commitment', weight: 2, blurb: 'Fifty years on one argument, against the current, with no expectation of being thanked for it.', laureates: ['rotblat', 'suttner', 'gbowee'], milestones: ['nuclear-arms'], related: ['conscience', 'persistence', 'courage'] },
  { id: 'early-impressions', label: 'Early Impressions', weight: 2, blurb: 'A famine seen at nine; a mill town; a prison visit. The question a laureate spends a career answering was usually asked of them as a child.', laureates: ['sen', 'yousafzai', 'alexievich'], milestones: [], related: ['youth', 'memory', 'inequality'] },
]

const ALL_LAUREATES = [
  { id: 'curie', name: 'Marie Curie', field: 'physics', year: 1903, country: 'Poland', blurb: 'Radioactivity, then radium and polonium — the only person awarded in two different sciences.', themes: ['persistence', 'invisible-worlds', 'the-atomic-age', 'women-rights', 'invisible-hands', 'influence'] },
  { id: 'einstein', name: 'Albert Einstein', field: 'physics', year: 1921, country: 'Germany', blurb: 'Awarded not for relativity but for the photoelectric effect — the paper that opened quantum theory.', themes: ['imagination', 'revolt', 'exile', 'doubt', 'scale', 'creativity'] },
  { id: 'rontgen', name: 'Wilhelm Röntgen', field: 'physics', year: 1901, country: 'Germany', blurb: 'A screen glowing across a darkened room; the first Nobel Prize in Physics, and the first X-ray.', themes: ['chance', 'accident', 'instruments', 'invisible-worlds', 'serendipity', 'observation'] },
  ...
  { id: 'fleming', name: 'Alexander Fleming', field: 'medicine', year: 1945, country: 'United Kingdom', blurb: 'An unwashed culture plate, a summer holiday, and a ring of dead bacteria around a mould.', themes: ['chance', 'accident', 'observation', 'antibiotics-t', 'healthcare', 'serendipity'] },
  ...
  { id: 'mandela', name: 'Nelson Mandela', field: 'peace', year: 1993, country: 'South Africa', blurb: 'Twenty-seven years in prison, then a negotiated end to apartheid shared with the man who had held him there.', themes: ['courage', 'revolt', 'conscience', 'peacebuilding', 'outsiders', 'persistence', 'patience'] },
  { id: 'yousafzai', name: 'Malala Yousafzai', field: 'peace', year: 2014, country: 'Pakistan', blurb: 'Seventeen years old: the youngest laureate in any category.', themes: ['courage', 'youth', 'women-rights', 'revolt', 'early-impressions'] },
  ...
  { id: 'doudna', name: 'Jennifer Doudna', field: 'chemistry', year: 2020, country: 'United States', blurb: 'CRISPR–Cas9: a bacterial immune system turned into an editing tool.', themes: ['genes', 'code', 'conscience', 'collaboration', 'dreams'] },
  ...
  { id: 'heisenberg', name: 'Werner Heisenberg', field: 'physics', year: 1932, country: 'Germany', blurb: 'Uncertainty as a law of nature — and a war spent leading the German nuclear programme.', themes: ['doubt', 'conscience', 'the-atomic-age', 'eureka', 'solitude', 'collaboration'] },
  ...
  // --- the shortlist ------------------------------------------------------
  // Fourteen laureates the cloud did not carry, added so the shortlist edition
  // has all twenty-four of its subjects.
  { id: 'townes', name: 'Charles Townes', field: 'physics', year: 1964, country: 'United States', blurb: 'Worked out the maser on a park bench in Washington at dawn, on a sheet of paper torn from an envelope.', themes: ['eureka', 'instruments', 'imagination'] },
  { id: 'lagerlof', name: 'Selma Lagerlöf', field: 'literature', year: 1909, country: 'Sweden', blurb: 'The first woman awarded the Literature prize, for a Värmland she wrote as legend rather than as landscape.', themes: ['eureka', 'inspiration', 'storytelling', 'women-rights'] },
  { id: 'rotblat', name: 'Joseph Rotblat', field: 'peace', year: 1995, country: 'Poland', blurb: 'The only physicist to leave the Manhattan Project on conscience, and then spend fifty years arguing against what it built.', themes: ['conscience', 'commitment', 'arms-defense', 'the-atomic-age'] },
  { id: 'gbowee', name: 'Leymah Gbowee', field: 'peace', year: 2011, country: 'Liberia', blurb: 'Organised Christian and Muslim women into a sit-in that would not leave until Liberia\'s warlords signed.', themes: ['courage', 'dreams', 'persistence', 'commitment', 'women-rights', 'peacebuilding'] },
  { id: 'mullis', name: 'Kary Mullis', field: 'chemistry', year: 1993, country: 'United States', blurb: 'Thought of PCR while driving Highway 128 at night, and pulled over twice to check the arithmetic.', themes: ['eureka', 'genes', 'code'] },
  { id: 'charpentier', name: 'Emmanuelle Charpentier', field: 'chemistry', year: 2020, country: 'France', blurb: 'Found the missing RNA in the CRISPR system, then walked up to a stranger at a conference in Puerto Rico.', themes: ['collaboration', 'genes', 'code', 'conscience'] },
  { id: 'beckett', name: 'Samuel Beckett', field: 'literature', year: 1969, country: 'Ireland', blurb: 'Wrote in French to make it harder. Learned of the prize on holiday and called it "a catastrophe".', themes: ['inspiration', 'creativity', 'influence', 'solitude', 'language'] },
  { id: 'yamanaka', name: 'Shinya Yamanaka', field: 'medicine', year: 2012, country: 'Japan', blurb: 'Took twenty-four candidate genes and removed them one at a time until four were left that could turn a skin cell back into a stem cell.', themes: ['testing', 'persistence', 'genes'] },
  { id: 'sen', name: 'Amartya Sen', field: 'economics', year: 1998, country: 'India', blurb: 'Was nine during the Bengal famine, and showed decades later that it happened in a year with enough food.', themes: ['early-impressions', 'inequality', 'economic-history', 'hunger'] },
  { id: 'suttner', name: 'Bertha von Suttner', field: 'peace', year: 1905, country: 'Austria', blurb: 'Nobel\'s one-time secretary, and the reason his will has a peace prize in it at all.', themes: ['commitment', 'women-rights', 'peacebuilding', 'arms-defense'] },
  { id: 'goldin', name: 'Claudia Goldin', field: 'economics', year: 2023, country: 'United States', blurb: 'Assembled two hundred years of American women\'s work from records that had never been read as data.', themes: ['inequality', 'women-rights', 'economic-history', 'persistence'] },
  { id: 'higgs', name: 'Peter Higgs', field: 'physics', year: 2013, country: 'United Kingdom', blurb: 'Predicted a particle in 1964 in a paper a journal rejected, and waited forty-eight years to be told it existed.', themes: ['patience', 'influence', 'imagination', 'scale'] },
  { id: 'hassabis', name: 'Demis Hassabis', field: 'chemistry', year: 2024, country: 'United Kingdom', blurb: 'Chess prodigy, then games programmer, then the protein-folding problem that biology had held open for fifty years.', themes: ['play', 'code', 'collaboration', 'instruments'] },
  { id: 'alexievich', name: 'Svetlana Alexievich', field: 'literature', year: 2015, country: 'Belarus', blurb: 'Built books out of hundreds of recorded voices — Chernobyl, Afghanistan, the Soviet century as its people tell it.', themes: ['storytelling', 'memory', 'truth', 'early-impressions'] },
]

// The atlas as this build carries it. Every reference to a laureate elsewhere
// resolves through findLaureate, which returns undefined for anyone the edition
// has left out — so a theme or a milestone that names them simply comes back
// with one fewer connection rather than a hole.
export const LAUREATES = ALL_LAUREATES.filter((l) => inEdition(l.id))
...
export const MILESTONES = [
  ...
  { id: 'human-rights', year: 1948, title: 'UN and Human Rights', blurb: 'A universal declaration, and a Peace Prize that starts rewarding institutions as well as individuals.', weight: 3, themes: ['peacebuilding', 'courage', 'truth', 'women-rights'], laureates: ['mandela', 'balch', 'addams'] },
