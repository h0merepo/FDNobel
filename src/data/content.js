...
export const THEMES = [
  ...
  { id: 'revolt', label: 'Revolt', weight: 2, blurb: 'Refusing the settled account. Every paradigm was once an act of disobedience.', laureates: ['mandela', 'einstein', 'mccli', 'sakharov'], milestones: ['modern-physics', 'human-rights'], related: ['courage', 'doubt', 'outsiders'] },
  ...
  { id: 'courage', label: 'Courage', weight: 2, blurb: 'Standing in the open when it costs something. Speech, exile, prison, silence broken.', laureates: ['mandela', 'addams', 'sakharov', 'suu-kyi', 'yousafzai'], milestones: ['human-rights', 'nazism'], related: ['revolt', 'conscience', 'women-rights'] },
  ...
  { id: 'conscience', label: 'Conscience', weight: 2, blurb: 'Scientists who campaigned against their own creations.', laureates: ['mandela', 'sakharov', 'pauling', 'einstein'], milestones: ['nuclear-arms'], related: ['courage', 'arms-defense', 'the-atomic-age'] },
  ...
  { id: 'peacebuilding', label: 'Peacebuilding', weight: 2, blurb: 'Settlement houses, mediation tables, refugee agencies — slow work with no clean ending.', laureates: ['mandela', 'addams', 'balch', 'suu-kyi'], milestones: ['human-rights', 'world-war-i'], related: ['courage', 'arms-defense', 'women-rights'] },
...
export const LAUREATES = [
  ...
  { id: 'mandela', name: 'Nelson Mandela', field: 'peace', year: 1993, country: 'South Africa', blurb: 'Twenty-seven years in prison, then a negotiated end to apartheid shared with the man who had held him there.', themes: ['courage', 'revolt', 'conscience', 'peacebuilding', 'outsiders'] },
